...
public class MemberUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		/*
		 * 1. 요청(파라미터,헤더,바디...)받고, 2.분석(검증) 3.통과 1)의존성 2)로직선택(ServiceResult
		 * modifyMember(member)) session에 메세지 넣기 - INVALIDPASSWORD : redirect -> mypage
		 * - OK : redirect -> mypage - FAILED : redirect -> mypage 4.불통과 : redirect ->
		 * mypage
		 * 
		 */
